<template>
  <div>
    <div class="search">
      <el-form ref="form">
        <span>
          <el-input v-model="form.meeting_number" placeholder="会议编号" style='width:200px; margin-right:10px;'></el-input>
        </span>
        <span>
          <el-input v-model="form.name" placeholder="主办方名称" style='width:200px; margin-right:10px;'></el-input>
        </span>
        <span>
          会议分类：
          <el-select v-model="form.meeting_type_id" placeholder="请选择" class='select' style='width: 100px'>
            <el-option v-for="item in options" :key="item.meetingtypeid" :label="item.typename" :value="item.meetingtypeid"></el-option>
          </el-select>
        </span>
        <span>
          显示状态：
          <el-select v-model="form.start" placeholder="请选择" class='select' style='width: 100px'>
    ...
    <div class="table">
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" highlight-current-row  @cell-click='selectMeeting'>
        ...
        <el-table-column prop="meeting_number" label="会议编号"> </el-table-column>
        <el-table-column prop="sponsorname"  label="主办方"> </el-table-column>
        <el-table-column prop="meeting_type_info.typename" label="会议分类"> </el-table-column>
        ...
        <el-table-column prop="lecturer_nums" label="讲师数量"></el-table-column>
