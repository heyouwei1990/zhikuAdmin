  ...
  <div>
    ...
    <div class="table">
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" highlight-current-row style="width: 100%" @select='select' @select-all='select' @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="name" label="推送名称" width="120"> </el-table-column>
        <el-table-column prop="phone" label="推送人群" width="120"> </el-table-column>
        <el-table-column label="创建时间" width="120">
          <template slot-scope="scope">{{ scope.row.date }}</template>
        </el-table-column>
        <el-table-column prop="address" label="推送内容" min-width="120"> </el-table-column>
    ...
    <div id="page">
      ...
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" class='page' :current-page="page" :page-sizes="[10, 20, 30, 40]" :page-size="pageSize" layout="total, sizes, prev, pager, next, jumper" :total="total"> </el-pagination>
    </div>
